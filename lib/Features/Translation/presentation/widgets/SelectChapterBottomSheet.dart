...
class SelectChapterBottomSheet extends StatefulWidget {
  ...
  @override
  State<SelectChapterBottomSheet> createState() =>
      _SelectChapterBottomSheetState();
}
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // Divider(
              //   height: 0,
              //   color: Color(0xff7f7f7f).withOpacity(.5),
              //   thickness: .5.h,
              // ),
              Expanded(
                child: Scrollbar(
                  ...
                  child: ListView.builder(
                      itemCount: chapterListAndDataProvider
                          .chapterListDataEntity?.chapters?.length,
