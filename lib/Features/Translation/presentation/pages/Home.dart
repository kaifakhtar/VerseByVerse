...
import '../../../Downloads/Translation_download/translation_download.dart';
...
class _HomeState extends State<Home> {
  ...
  void download_translation() {
    final translationDownload = TranslationDownload();

    translationDownload.hilali_translation_download();
